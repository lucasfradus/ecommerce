<div class="col-lg-12">
    <div class="element-box">
        <?php     
            ...
            echo form_hidden('id',$result->id_menu);
        ?>
            <div class="form-group">
                <label for="descripcion">Descripcion<span class="required">*</span></label>                                
                <input id="descripcion" required type="text" name="descripcion" value="<?php echo $result->description ?>" class="form-control" />
            </div>
            ...
            <div class="form-group">
              ...
              <select id="parent" required name="parent" class="chosen-select form-control">
                ...
                <?php foreach ($parents as $f) { ?>
                    <option value="<?php echo $f->id_menu ?>" <?php if($result->parent==$f->id_menu) echo "selected" ?>><?php echo $f->description ?></option>
                <?php } ?>
              </select>
            </div>
