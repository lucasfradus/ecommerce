...
<center class="wrapper">
      <table class="header centered">
        <tbody><tr><td class="border">&nbsp;</td></tr>
        <tr><td class="logo"><div align="center" id="emb-email-header" class="logo-center"><img src="<?php echo base_url() ?>assets/public/brand.png" alt=""></div></td></tr>
      </tbody></table>
