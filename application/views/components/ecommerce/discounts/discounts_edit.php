            ...
            <div class="hide">
                <div class="col-sm-6">
                    <div class="form-group">
                        <input id="minimo" name="minimo" type="hidden" class="form-control" placeholder="Min." value="<?php echo $result->min ?>" />
                    </div>
                </div>  
            </div>
            <input id="maximo" name="maximo" type="hidden" class="form-control" placeholder="Max." value="<?php echo $result->max ?>" />
            <div class="col-sm-6">
                <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input step=".01" type="number" min="1" max="99" id="discount"  type="text" name="discount" value="<?php echo $result->discount ?>" class="form-control" />  
                    </div>
                </div>
            </div>
            <hr>
...
<script type="text/javascript">
    var minimo = <?php echo $result->min ?>;
    var maximo = <?php echo $result->max ?>;
    $(function() {
